...
import { Menu, X, Sun, Moon, BookOpen, Home } from "lucide-react"
        ...
        <nav className="hidden md:flex items-center gap-8">
          {!isHomePage && (
            <button
              ...
              className="text-sm font-medium text-[#4b7bb5] hover:text-[#3d649e] dark:text-[#6b91c1] dark:hover:text-white transition-colors relative group flex items-center gap-1"
            >
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            className={`hidden md:flex items-center gap-1 ${
              pathname.startsWith("/blog") ? "bg-[#3d649e] hover:bg-[#4b7bb5]" : "bg-[#527eb7] hover:bg-[#3d649e]"
            } text-white dark:bg-[#6b91c1] dark:hover:bg-[#4b7bb5] transition-colors`}
          >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <nav className="flex flex-col gap-4">
            {!isHomePage && (
              <button
                onClick={navigateToHome}
                className="py-3 px-4 text-lg font-medium text-[#4b7bb5] hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md transition-colors flex items-center gap-2"
              >
            ...
            <button
              ...
              className={`py-3 px-4 text-lg font-medium ${
                pathname.startsWith("/blog") ? "bg-[#3d649e] hover:bg-[#4b7bb5]" : "bg-[#527eb7] hover:bg-[#3d649e]"
              } text-white dark:bg-[#6b91c1] dark:hover:bg-[#4b7bb5] rounded-md transition-colors flex items-center justify-between`}
            >
